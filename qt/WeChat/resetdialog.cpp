...
ResetDialog::ResetDialog(QWidget *parent)
    : QDialog(parent), ui(new Ui::resetDialog), _corrects(std::vector<int>(3, 0))
{
    ui->setupUi(this);
    polish(); // 刷新qss
    // 处理注册完成信号
...
// 添加鼠标事件处理函数的实现
void ResetDialog::mousePressEvent(QMouseEvent *event)
{
    // 判断鼠标是否在titlebar区域内
...
void ResetDialog::mouseMoveEvent(QMouseEvent *event)
{
...
void ResetDialog::mouseReleaseEvent(QMouseEvent *event)
{
